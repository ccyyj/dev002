...
public class MailTest {
    ...
    void testHtmlMail() {
        ...
        try {
            helper.setFrom("2256818165@qq.com");
            // 设置发送的时间（定时邮件）
            ...
            helper.setBcc("3418656303@qq.com");
    ...
    void testSimple() {
        ...
        // 发送人
        message.setFrom("2256818165@qq.com");
        // 接收者
        message.setTo("13781737921@qq.com");
        // 抄送人
        message.setCc("3055267245@qq.com");
        // 秘密抄送，只有发送人和密抄者能够看到
        message.setBcc("3418656303@qq.com");
        // 邮件主题
